...
Para entender esta idea consideremos una base de datos construida con uno de 
...
espacio de dimensión $100 \times 100 = 10,000$; sin embargo, en una tabla
de datos construida de esta manera solamente hay 3 grados de libertad, 
estas corresponden a las rotaciones, trasalación vertical y 
traslación horizontal. 

Para datos reales habrá más grados de libertad debido por una parte a
escalamiento y por otra habrá múltiples grados adicionales resultantes de 
deformaciones ante la variabilidad en la escritura de un individuo y entre
individuos. Aún así, la dimensionalidad de los grados de libertad es mucho
...
Por su partem el análisis de componentes principales (PCA) es una técnica que 
se utiliza con distintos objetivos:
...
Consideremos un vector de observaciones $(y_1,...,y_n)$ donde $y_i$ es de 
